...
namespace Damian.MWGK.Global.Zbiory
{
    ...
    class Mapy //glowna funkcja odpowiadajaca za gre hell yeah,nareszcie sie tu dostalem
    {
        ...
        protected static void InitFal()
        {
            ...
            statki.Add(new StatekInformacja(Statki[0].Kopia(), -30, null, null, null, null, 60, 1, 1.0f, false, true));
            ...
            statki = new List<StatekInformacja>();
            statki.Add(new StatekInformacja(Statki[0].Kopia(), 0, null, null, null, null, 180, 60, 2.0f, true, true));
            statki.Add(new StatekInformacja(Statki[0].Kopia(), -30, null, null, null, null, 180, 60, 2.0f, true, true));
        ...
        protected static FalaInformacyjna StworzFale(StatekInformacja Statek, int ile,byte Tor)
        {
            List<StatekInformacja> Statki = new List<StatekInformacja>();
            for (int i = 0; i < ile; i++)
                Statki.Add(Statek);
            return new FalaInformacyjna(ToryX[Tor], ToryY[Tor], ToryT[Tor], ToryLaseryOd[Tor], ToryLaseryDo[Tor], ToryRakietyOd[Tor], ToryRakietyDo[Tor],Statki);
        }

        //Zmienne do przejsc
        public static int Przejscie = 0;
        public static bool PrzejscieRozpoczete = false;
        public static void PrzejscieZ()
        {
            ...
            Przejscie--;
            if (Przejscie == 0)
                GlobalAcc.StanGry = GameState.Game;
        }
        ...
        protected static void MapInit()
        {
            ...
            Kiedy.Add(0);
            Fale.Add(StworzFale((byte)RodzajeFal.LaserNamierzalnaRakietowaNamierzalnaSlaba, (byte)RodzajeTorow.PrawaGornaXSordekXLewaGornaYNormalT));
            Kiedy.Add(150);
            Fale.Add(StworzFale((byte)RodzajeFal.LaserNamierzalnaRakietowaNamierzalnaSlabaSzybka, (byte)RodzajeTorow.PrawyGornyXGlebokiXLewyGornyYNormalT));
            Kiedy.Add(400);
            Fale.Add(StworzFale((byte)RodzajeFal.LaserNamierzalnaRakietowaNamierzalnaSlabaSzybka, (byte)RodzajeTorow.LewyGornyXGlebokiXPrawyGornyYNormalT));
            Kiedy.Add(400);
            Fale.Add(StworzFale((byte)RodzajeFal.RakietowaNamierzanaSlaba, (byte)RodzajeTorow.LewaGornaXSrodekXGornaPrawaYNormalT));
            Kiedy.Add(550);
            Fale.Add(StworzFale((byte)RodzajeFal.LaserowaNamierzalnaSlaba, (byte)RodzajeTorow.PrawaGornaXSordekXLewaGornaYNormalT));
            Kiedy.Add(700);
            Fale.Add(StworzFale((byte)RodzajeFal.RakietowaNamierzanaSlaba, (byte)RodzajeTorow.PoziomYNormalT));
            Kiedy.Add(860);
            Fale.Add(StworzFale((byte)RodzajeFal.LaserNamierzalnyRakietyNienamierzalneSredni, (byte)RodzajeTorow.GornySrodekXDolnySrodekYSlowT));
            Kiedy.Add(1000);
            ListaMap[0] = new Mapa(9000, false, Fale, Kiedy);
            //----------------------MAPA1-----------------
            Fale = new List<FalaInformacyjna>();
            new List<int>();
            Fale.Add(StworzFale((byte)RodzajeFal.LaserNamierzalnyRakietyNienamierzalneSredni, (byte)RodzajeTorow.GornySrodekXDolnySrodekYSlowT));
            Kiedy.Add(0);
            Fale.Add(StworzFale((byte)RodzajeFal.LaserNamierzalnyRakietyNienamierzalneSredni, (byte)RodzajeTorow.PoziomYNormalT));
            Kiedy.Add(50);
            Fale.Add(StworzFale((byte)RodzajeFal.LaserowaNamierzalnaSlaba, (byte)RodzajeTorow.GornySrodekXDolnySrodekYSlowT));
            Kiedy.Add(400);
